...
import com.build.GradleForHerokuApp;
import com.build.domain.Authority;
import com.build.domain.User;
import com.build.repository.AuthorityRepository;
import com.build.repository.UserRepository;
import com.build.security.AuthoritiesConstants;
import com.build.service.MailService;
import com.build.service.UserService;
import com.build.service.dto.UserDTO;
import com.build.web.rest.vm.KeyAndPasswordVM;
import com.build.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = GradleForHerokuApp.class)
